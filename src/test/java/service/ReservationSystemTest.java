...
public class ReservationSystemTest {
    ...
    public void setUp() {
        ...
        conferenceRoomDaoMock = mock(ConferenceRoomDao.class);
        system = new ReservationSystem(conferenceRoomDaoMock);
    }

    @Test
    public void testReserveRoomWhenIsFalse() {
        when(conferenceRoomDaoMock.getRoomById("romm1")).thenReturn(null);
    ...
    public void testReserveRoomWhenIsTrue() {
        ...
        when(conferenceRoomDaoMock.getRoomById("room2")).thenReturn(prueba2);
        assertEquals(true, system.reserveRoom("room2"));
    }

    @Test
    public void testCancelReservationWhenIsFalse() {
        when(conferenceRoomDaoMock.getRoomById("romm3")).thenReturn(null);
    ...
    public void testCancelReservationWhenIsTrue() {
        ...
        when(conferenceRoomDaoMock.getRoomById("room4")).thenReturn(prueba3);
    ...
    void testGetAvailableRooms() {
        ...
        when(conferenceRoomDaoMock.getAllRooms()).thenReturn(List.of(room1, room2, room3, room4));
